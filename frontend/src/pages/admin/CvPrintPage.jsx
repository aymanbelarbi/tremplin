        ...
        <div className="cv-grid-wrap">
          ...
          <div className="cv-grid">
            ...
            <div className="cv-main">
              ...
              {skills.length > 0 && (
                <div className="cv-section">
                  <h2 className="cv-main-title">Compétences de base</h2>
                  <ul className="cv-list">
                    {skills.map((s, idx) => (
                      <li key={typeof s === 'string' ? `${s}-${idx}` : s.name || s.id}>{typeof s === 'string' ? s : s.name}</li>
                    ))}
                  </ul>
                </div>
              )}
              ...
              {certifications.length > 0 && (
                <div className="cv-section">
                  <h2 className="cv-main-title">Compétences complémentaires</h2>
                  <ul className="cv-list">
                    {certifications.filter((c) => c?.name).map((c) => (
                      <li key={c.id || c.name}>{c.name}{c.year ? ` (${c.year})` : ''}</li>
                    ))}
                  </ul>
                </div>
              )}
